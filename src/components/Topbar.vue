  ...
  <nav class='navbar navbar-light'>
    <div class='container'>
      ...
      <template v-if='isLoggedIn'>
        <li class='nav-item'>
          <router-link class='nav-link' :to="{name: 'createArticle'}"><i class='ion-compose'></i> &nbsp; New Article</router-link>
        </li>
        <li class='nav-item'>
          <router-link class='nav-link' :to="{name: 'settings'}"><i class='ion-gear-a'></i> &nbsp; Settings</router-link>
        </li>
        <li class='nav-item'>
